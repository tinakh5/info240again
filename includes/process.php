...
$requiredFields = "name,email,ques-comm,survey";

$defaultText = "Please type your information below.";

$errorText = "Please complete the required fields to submit!";

$successText = "Thank you for completing the survey!";
...
$multiFields = "source,topics,survey";
